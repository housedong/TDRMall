...
public class Product implements Serializable {
    ...
    public Product(Integer id, String title, Double marketPrice, Double shopPrice, String image, String desc, Integer isHot, Integer csid, Date pdate, Double cost,Integer stock) {
        this.id = id;
        this.title = title;
